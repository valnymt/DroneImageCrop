...
type AnalysisResult = {
  ...
  // but real detections instead of a guaranteed zero on an unfamiliar
  // photo. detection_note always explains what happened either way.
  detection_method: "fine_tuned" | "general_fallback";
